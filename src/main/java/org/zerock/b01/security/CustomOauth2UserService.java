...
public class CustomOauth2UserService extends DefaultOAuth2UserService {
    ...
    //  소셜에 등록된 이메일을 통해서 사용자 구분을 하는데
    //  없는 경우 멤버 추가 설정을 위해서 DI
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        log.info("Name= "+clientName);  //  어떤 소셜을 사용하는지.
        ...
        String email = null;
        switch (clientName){    //  각 소셜에 맞춰서 지정할 수 있게 clientName 사용
            case "kakao":
...
//        });
        ...
        return generateDTO(email, paramMap);    //  MemberServiceDTO로 반환 처리
    }

    //  getKakaoEmail - KAKAO 에서 전달된 정보를 통해서 Email 반한 처리
